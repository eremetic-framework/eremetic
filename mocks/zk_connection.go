...
// ZkConnection is an autogenerated mock type for the ZkConnection type
type ZkConnection struct {
	mock.Mock
}

// Children provides a mock function with given fields: path
func (_m *ZkConnection) Children(path string) ([]string, *zk.Stat, error) {
	ret := _m.Called(path)
...
func (_m *ZkConnection) Close() {
	_m.Called()
}

// Create provides a mock function with given fields: path, data, flags, acl
func (_m *ZkConnection) Create(path string, data []byte, flags int32, acl []zk.ACL) (string, error) {
...
func (_m *ZkConnection) Delete(path string, n int32) error {
...
func (_m *ZkConnection) Exists(path string) (bool, *zk.Stat, error) {
	ret := _m.Called(path)
...
func (_m *ZkConnection) Get(path string) ([]byte, *zk.Stat, error) {
	ret := _m.Called(path)
...
func (_m *ZkConnection) Set(path string, data []byte, version int32) (*zk.Stat, error) {
